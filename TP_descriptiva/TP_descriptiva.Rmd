...
Ahora si son mas claras las diferencias de precio barrio a barrio.
...
barplot(t(t(propbarrio) / colSums(propbarrio)), col = col_propiedades, legend.text = TRUE, main = "Composicion de tipos de propiedad") # (?) como ubicar leyenda, arreglar labels que no aparecen
```

Con esta informacion en mente, estaria bueno comparar lado a lado los graficos de superficie y precio por tipo de propiedad y barrio - dos formas distintas de agrupar la misma correlacion.
